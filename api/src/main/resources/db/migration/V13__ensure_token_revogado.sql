CREATE TABLE IF NOT EXISTS token_revogado (
    ...
    CONSTRAINT uq_token_revogado_token UNIQUE (token)
);
...
'Dado e horário de expiração natural do token. Utilizado para limpeza automática de registros obsoletos via job agendado.';
