...
class CaronaServiceTest {
    ...
    class ListarPassageiros {
        ...
        void deveListarPassageiros() {
            ...
            when(reservaCaronaRepository
                    .findByCaronaIdAndStatus(
                            caronaId,
                            StatusReserva.ACEITA
                    ))
                    .thenReturn(reservas);

            List<PassageiroResponseDTO> resultado =
                    caronaService.listarPassageiros(
                            caronaId,
                            motoristaId
                    );
            ...
            verify(reservaCaronaRepository)
                    .findByCaronaIdAndStatus(
                            caronaId,
                            StatusReserva.ACEITA
                    );
    ...
    class FinalizarCarona {
        ...
        void deveFinalizarCarona() {
            ...
            ReservaCarona reserva =
                    mock(ReservaCarona.class);


            List<ReservaCarona> reservas =
                    List.of(reserva);
